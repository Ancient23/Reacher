...
from reachy_fleet_supervisor.config import config
from reachy_fleet_supervisor.prompts import get_session_voice, get_session_instructions
from reachy_fleet_supervisor.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
)
from reachy_fleet_supervisor.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from reachy_fleet_supervisor.config import config as _config
